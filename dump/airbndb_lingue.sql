...
--
-- Dumping data for table `lingue`
--

LOCK TABLES `lingue` WRITE;
/*!40000 ALTER TABLE `lingue` DISABLE KEYS */;
INSERT INTO `lingue` VALUES ('Arabo'),('Coreano'),('Francese'),('Giapponese'),('Greco'),('Inglese'),('Italiano'),('Spagnolo'),('Tedesco');
